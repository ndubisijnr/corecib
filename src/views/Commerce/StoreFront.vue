...
<base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 d-inline-block mb-0">Storefront</h6>
...
<div  class="col-6 text-right mt-3">
  ...
  <i class="fa fa-plus "></i>New Storefront
  </base-button>
...
<template #row-details="row">
      ...
      <div class="row">
        <div class="col">
          <div class="no-data text-center ">
            ...
            <h3>Welcome to Storefronts</h3>
            <p>
             Sell multiple products on a single page 
              <br /><br />
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
              ...
              <!--</div>-->
              <div class="py-2">
            <h5 class="h3 mb-0 text-left">New Storefront</h5>
             </div>
          ...
          <form id="form1" @submit.prevent="submitForm1">
           ...
           <div class="form-group">
            ...
            <el-select class="select-danger" filterable size="small"
             ...
             v-model="name">
    <el-option v-for="option in [{label:'NGN',value:'NGN'},{label:'USD',value:'USD'}]"
               class="select-danger"
               :value="option.value"
               :label="option.label"
               :key="option.value">
            ...
            <div class="form-group ">
            <label class="form-control-label">Store Link<span class="text-danger">*</span></label> 
            <input type="text" v-model="name" autocomplete="off" name="link" placeholder="" class="form-control" required>
            </div>
