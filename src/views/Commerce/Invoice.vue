    ...
    <!--<div class="col-lg-4 col-md-4 col-sm-4 col-12">
        <user-info></user-info>
         ...
         <!--<div class="col-lg-12 col-md-12 col-sm-12 col-12">    -->
             <div class="flex">
                 <div class="order-table flex-direction--column">
             <!--<card class="no-border-card" body-classes="px-1 pb-1">-->
...
<template #row-details="row">
  ...
  <i class="fa fa-plus "></i>Go to plan
  </base-button>-->
          </div>
        </div>
      </div>
            ...
            <div class="order-table-side ">
              <div class="page-table-head-side">
                <span class="text-center">Statistics</span>
              </div>
              <div class="mt-2 px-1 py-2 text-center">
                ...
                <div class="mt-3 ml-3">
                  <div class="row">
                <div class="col-12">
                    <span class="text-muted text-sm mb-2">Orders</span>
                    </div>
                  <div class="col-12">
                <span class=" mt-2 text-muted text-bold" >7</span>
                </div>
              </div>
                <div class="row mt-3">
                <div class="col-12">
                    <span class="text-muted text-sm mb-2">Revenue</span>
                    </div>
                  <div class="col-12">
                <span class=" mt-2 text-muted text-bold" >0</span>
                </div>
              </div>
            </div>
    </div>
...
<!--</div>-->
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
              ...
              <!--</div>-->
              <div class="py-2">
            <h5 class="h3 mb-0 text-left">New Split Group</h5>
             </div>
        ...
        <div class="card-body">
          <form id="form1" @submit.prevent="submitForm1">
            ...
            <label class="form-control-label">Split Group Name<span class="text-danger">*</span></label> <!--<span class="input-group-text" @click="showPassword = !showPassword">
            <i class="fa" :class="[showInfo ? 'fa-eye' : 'fa-eye-slash']" aria-hidden="true"></i>
      </span>-->
            <input type="text" v-model="name" autocomplete="off" name="name" placeholder="Name of your page" class="form-control" required>
            </div>
            
            <div class="form-group ">
            <label class="form-control-label">Currency</label>
            <el-select class="select-danger" filterable size="small"
             placeholder="Currency of payment"
             v-model="currency">
    <el-option v-for="option in [{label:'NGN',value:'NGN'}]"
               class="select-danger"
               :value="option.value"
               :label="option.label"
               :key="option.value">
  ...
  <p v-show="currencyCtrl" class="form-error-message"> The Currency is required </p>
        ...
        <div class="form-group">
    <label class="form-control-label">Choose Split Type</label>
      <b-form-radio v-model="selected_type"  name="some-radios" value="Percentage Split">Option A</b-form-radio>
      <b-form-radio v-model="selected_type"  name="some-radios" value="Flat Split">Option B</b-form-radio>
        </div>
