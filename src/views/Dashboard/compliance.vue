                ...
                <div v-if="true">
                  ...
                  <div class="" style="display: flex; width: 100%">
                    ...
                    >
                      ...
                      >
                        <div class="card" style="width: 500px; padding: 20px"  v-if="show == 'firstt'">
                          <div class="">
                            <span>Country</span><br />
                            <b>
                              <span>{{ user.customerCountry }}</span></b
                            ><br /><br />

                            <span>Email</span><br />
                            <b>
                              <span>{{ user.customerEmail }}</span></b
                            ><br /><br />
                            ...
                            >
                              <button class="btn btn-outline-light" @click="showedit()">
                                Edit
                              </button>
                              <button
                        ...
                        <div class="" id="list-item-1" v-if="edit == 'first'">
                          <div class="">
                      ...
                      >
                        <div class="card" style="width: 500px; padding: 20px">
                          ...
                          <b>  <span>{{
                              user.organisations[0].organisationEmail
                            }}</span></b>
                            <br /><br />

                            <span>Phone Number</span><br />
                           <b> <span>{{
                              user.organisations[0].organisationPhone
                            }}</span
                            ></b><br /><br />

                            <span>Business Name</span><br />
                            <b> <span>{{
                              user.organisations[0].organisationName
                            }}</span
                            ></b><br /><br />
                        ...
                        <div class="row" id="list-item-1" v-if="show == 'edit'">
                          <div class="col-lg-12">
                            <div class="card center-block">
                              <form class="px-2">
                                <h4
                      ...
                      >
                        <div class="card" style="width: 500px; padding: 20px">
                          <div class="">
                            ...
                            <span>Nigeria</span><br /><br />

                            <span>Account Number</span><br />
                            <span>Nigeria</span><br /><br />

                            <span>Name on Account</span><br />
                            <span>Nigeria</span><br /><br />
                      ...
                      >
                        <div class="card" style="width: 500px; padding: 20px">
                          <div class="">
                            ...
                            <span>Please upload all documents</span><br /><br />
                          </div>
                        </div>

                        <div class="card" style="width: 500px; padding: 20px">
                          <div class="">
                            <span>Directors</span><br />
                            <span
                              >Please identify at least 2 directors of your
                              business</span
                            ><br /><br />
                          </div>
                        </div>
                        ...
                        <div class="card" style="width: 500px; padding: 20px">
                          <div class="">
                            <span>Beneficial Owners</span><br />
                            <span
                              >Please identify people who, together, own at
                              least 50% of this business</span
                            ><br /><br />
                          </div>
                        </div>
          ...
          <div class="row">
            <div class="col">
              <div class="no-data text-center">
                <div class="empty-history">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
                      ...
                      <line x1="25" y1="10" x2="25" y2="32" class="a"></line>
                      <line
                        x1="25"
                        y1="37"
                        x2="25"
                ...
                <h3>No Customer</h3>
                <p>
                  There're no Customer for this query. Please try another query
        ...
        <div class="card-footer">
          <div class="row">
            <div class="col-6 text-left">
              <button @click="closeModal0()" class="btn btn-light">
                Cancel
              </button>
            </div>
            <div class="col-6 text-right">
              <button form="form1" type="submit" class="btn btn-danger">
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      api: (state) => state.readApikey.readApikey,
...
this.fields.push({
  ...
  mounted: function () {
    ...
    const organazationId = this.user.customerId;
    this.$store.dispatch(
      "readApiKey",
      { apikeyOrganisationId: organazationId },
      { root: false }
    );
  },
};
