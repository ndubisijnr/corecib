...
export default {
  components: {
    BaseHeader,
    // CashWithDrawalCheckersQueueTable
  },
  ...
  computed: {
    ...mapState({
      ...
      api: (state) => state.auth.apiKey,
      loading: (state) => state.auth.loading,
      isSwitched: (state) => state.auth.switchmode

    }),
  },

  // beforeMount() {
  //   this.$store.dispatch("readApiKey",{apikeyOrganisationId: this.user.customerId})
  // },
