...
<base-header class="pb-6" type="">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 d-inline-block mb-0">Transaction Split</h6>
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              <li class="breadcrumb-item"><router-link to="/"><i class="fas fa-home"></i></router-link></li>
              <li class="breadcrumb-item"><a href="#">Transaction</a></li>
              <li class="breadcrumb-item active" aria-current="page">Transaction Split</li>
            </ol>
          </nav>
        </div>
...
<div  class="col-6 text-right mt-3">
  ...
  <i class="fa fa-plus "></i>New Split Group
  </base-button>
      ...
      <div class="row">
        <div class="col">
          <div class="no-data text-center ">
            ...
            <h3>No result</h3>
            <p>
              Your query returned no transaction splits. Please try another query or clear your filters.
              <br /><br />
