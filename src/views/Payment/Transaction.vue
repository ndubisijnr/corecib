...
<div>
  ...
  <!--              <li class="breadcrumb-item active" aria-current="page">Payment</li>-->
          ...
          <div class="col-lg-6 col-5 text-right">
            <base-button size=md type="neutral"> Add New User</base-button>
                ...
                <div style="display:flex;">
                 <span>
                  ...
                  <!--<span class="btn btn-md text-light">-->
                    <a class="hand pr-0" ><i class="fa fa-filter mr-1"></i>Filters</a>
                  <!--</span>-->
          <template #dropdown>
...
import UsersCardComp from "@/components/UserCard/UsersCardComp";
