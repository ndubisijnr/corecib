        ...
        <div class="col-lg-6 col-7">
          ...
          <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
            <ol class="breadcrumb breadcrumb-links">
              ...
              <li class="breadcrumb-item"><a href="#">Recurring</a></li>
      ...
      <div class="row">
        <div class="col">
          <div class="no-data text-center ">
            ...
            <h3>Plans</h3>
            <p>
              Set up schedules for collecting recurring <br>
payments from your customers.
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
              ...
              <!--</div>-->
              <div class="py-2">
            <h5 class="h3 mb-0 text-left">New Plan</h5>
             </div>
        ...
        <div class="card-body">
          <form id="form1" @submit.prevent="submitForm1">
            ...
            <label class="form-control-label">Plan Name<span class="text-danger">*</span></label> <!--<span class="input-group-text" @click="showPassword = !showPassword">
            ...
            <textarea class="form-control" placeholder="Describe your plan (Optional)"  v-model="name" rows="4" cols="50"></textarea>
            </div>
            <div class="form-group">
                <label class="form-control-label">Plan Amount</label>
                <div class="row">
                    <div class="col-3">
            ...
            <a class="dropdown-item" href="#">USD</a>
                    ...
                    <div class="col-9">
                        <input type="number" v-model="name" autocomplete="off" name="name" placeholder="Cost of plan (NGN)" class="form-control" >
                    </div>
                </div>
                 <span class="text-sm text-muted">Minimum Plan amount is NGN 100</span>
              </div>
            <div class="form-group">
            ...
            <el-select class="select-danger" filterable size="small"
             ...
             v-model="name">
    <el-option v-for="option in [{label:'Hourly',value:'Hourly'},{label:'Weekly',value:'Weekly'},{label:'Monthly',value:'Monthly'},
    {label:'Quarterly',value:'Quarterly'},{label:'Biannually',value:'Biannually'},{label:'Annually',value:'Annually'}]"
               class="select-danger"
               :value="option.value"
               :label="option.label"
               :key="option.value">
